...
<body>
    <div id="background">
		<div id="position">
			<h1>Error 500 - Erreur interne du serveur</h1>
			<div class="h1">L'action attendue ne s'est pas déroulée correctement ou a échouée.<div>Nous en avons été informés et agirons au plus vite.</div></div>
			
			<ul>
				<li>Vous avez essayé d'atteindre <b>${pageContext.errorData.requestURI}</b> via un lien de <b>${header.host}</b>.</li>	
				<li>Essayez de retourner à la <a href="https://www.fc-sante.fr/annuaire/">page d'accueil</a> et de continuer vos démarches.</li>
			</ul>

...
function modifierAdresse(id) {
    ...
    document.getElementById("btnmodifieradr").onclick = function() {
        modificationAdresse(id);
    };
...
function modifierTelephone(id) {
    ...
    document.getElementById("btnmodifiertel").onclick = function() {
        modificationTelephone(id);
    };
...
function modifierMail(id) {
    ...
    document.getElementById("btnmodifiermail").onclick = function() {
        modificationMail(id);
    };
...
function modifierOffreSoins(id) {
    ...
    document.getElementById("btnmodifoffre").onclick = function() {
        modificationOffreSoins(id);
    };
...
function creerCalendrier() {
    ...
    $.get("/PagesSante" + servletPath + "/calendrier/creercalendrier", function(data) {
        ...
        $(".timeCalendrier").timepicker({showPeriodLabels: false, onSelect: function() {
                this.focus();
            }});

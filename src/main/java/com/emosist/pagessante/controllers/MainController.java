...
public class MainController {
    ...
    /**
     * Retourne le mot de passe fourni par l'entête HTTP, l'attribut de
     * session ou les APIs JAAS. Appel l'implémentation par défaut si rien n'est
     * trouvé.
     * 
     * @param request
     ...
     * 
     * @param jspPage
     *            Page de redirection si login Ok
     * @param request
     *            requête http transmise par le client
     ...
     * 
     * @param typeentite
     *            type de l'entité demandée
     * @param identite
     *            identifiant de l'entité demandée
     * @param request
     *            requête http transmise par le client
     */
